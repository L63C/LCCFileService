...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LCCFileService.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lu63chuan@163.com/LCCFileService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lu63chuan@163.com' => 'lu63chuan@163.com' }
  s.source           = { :git => 'https://github.com/lu63chuan@163.com/LCCFileService.git', :tag => s.version.to_s }
